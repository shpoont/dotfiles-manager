...
truth about previews, desired data, trust, ledgers, write safety, native
...
- explanation of desired artifacts without leaking internal layout
  first;
- safety boundaries for live state, trust, ledgers, write safety, native
...
- omits ledger/trust/write-safety or live-state boundaries;
...
- ledger, verification, and internal recovery-evidence integration tests;
