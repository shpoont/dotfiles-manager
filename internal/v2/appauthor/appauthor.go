...
func renderFixturesReadme(targetID string) string {
	return strings.Join([]string{
		...
		"",
		"Fixtures are optional in this tranche. Use this directory for future roundtrip examples only when the fixture contents are synthetic or sanitized.",
		"",
		"Do not place real secrets, tokens, private account identifiers, or unsanitized personal data in fixtures.",
		"",
		"Roundtrip execution is intentionally not implemented by `app validate` in this issue; `app validate` only checks recipe metadata and reports this fixture area as skipped.",
		"",
	}, "\n")
}
